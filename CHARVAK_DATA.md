# 📊 Charvak Reservoir Technical & Hydrological Reference Data
# 📊 Чарвакское Водохранилище: Технические и Гидрологические Данные
# 📊 Chorvoq Suv Omborining Texnik va Gidrologik Ko'rsatkichlari

> **Comprehensive engineering, morphometric, and hydrological dataset** for the Charvak Reservoir, Dam, and Hydroelectric Complex on the Chirchik River, Tashkent Region, Uzbekistan.

---

## 📑 Contents / Содержание / Mundarija
1. [General Overview / Общие сведения / Umumiy ma'lumotlar](#1-general-overview)
2. [Morphometric & Storage Capacities / Морфометрия и объемы / Sig'im va o'lchamlar](#2-morphometric--storage-capacities)
3. [Dam Engineering Specifications / Параметры плотины / To'g'on parametrlari](#3-dam-engineering-specifications)
4. [Spillways & Outlets / Водосбросы и водовыпуски / Suv tashlash inshootlari](#4-spillways--outlet-structures)
5. [Hydroelectric Power Station / Чарвакская ГЭС / Chorvoq GES](#5-charvak-hydroelectric-power-station)
6. [Basin Hydrology & Cascade / Бассейн и каскад / Daryo havzasi va kaskad](#6-basin-hydrology--downstream-cascade)
7. [Seismic Design & Dam Safety / Сейсмостойкость и безопасность / Xavfsizlik va seysmik chidamlilik](#7-seismic-design--monitoring)
8. [Historical Timeline / Хронология / Tarixiy ma'lumotlar](#8-historical-timeline)
9. [Key Parameters for Dam-Break Modeling / Параметры для моделирования](#9-parameters-for-dam-break-modeling)
10. [Data Sources & References / Источники / Manbalar](#10-data-sources--references)

---

## 1. General Overview

| Parameter | Value (English) | Значение (Русский) | Qiymat (O'zbekcha) |
| :--- | :--- | :--- | :--- |
| **Official Name** | Charvak Reservoir | Чарвакское водохранилище | Chorvoq suv ombori |
| **HPP Complex** | Charvak Hydroelectric Power Plant | Чарвакская ГЭС | Chorvoq GES |
| **Location** | Bostanlyk District, Tashkent Region, Uzbekistan | Бостанлыкский район, Ташкентская область, Узбекистан | Bo'stonliq tumani, Toshkent viloyati, O'zbekiston |
| **Geographic Region** | Western Tian Shan (Chatkal & Ugam spurs) | Западный Тянь-Шань (отроги Чаткальского и Угамского хребтов) | G'arbiy Tyanshan (Chotqol va Ugom tog' tizmalari) |
| **Coordinates** | 41°37′38″ N, 70°01′57″ E | 41°37′38″ с. ш., 70°01′57″ в. д. | 41°37′38″ SH, 70°01′57″ SH |
| **Primary River** | Chirchik River | Река Чирчик | Chirchiq daryosi |
| **Formed By Confluence** | Pskem, Chatkal, and Koksu rivers | Слияние рек Пскем, Чаткал и Коксу | Pskem, Chotqol va Ko'ksuv daryolari qo'shilishi |
| **Commissioning Year** | 1970 (First unit), 1972 (Full completion) | 1970 (первый гидроагрегат), 1972 (полный ввод) | 1970 (1-gidroagregat), 1972 (to'liq foydalanishga topshirish) |
| **Primary Purpose** | Hydropower, irrigation, flood control, Tashkent water supply, recreation | Гидроэнергетика, ирригация, защита от паводков, водоснабжение Ташкента, рекреация | Gidroenergetika, sug'orish, toshqinga qarshi kurash, Toshkentni suv bilan ta'minlash, turizm |
| **Operating Organization** | JSC "Uzbekhydroenergo" (Cascade of Charvak HPPs) | АО «Узбекгидроэнерго» (Каскад Чарвакских ГЭС) | "O'zbekgidroenergo" AJ (Chorvoq GESlar kaskadi) |

---

## 2. Morphometric & Storage Capacities
...
## 3. Dam Engineering Specifications
...
## 4. Spillways & Outlet Structures

The Charvak dam is equipped with two independent hydraulic safety discharge systems:

```
                  ┌────────────────────────────────────────────────────────┐
                  │                 CHARVAK DISCHARGE SYSTEM               │
                  └───────────────────────────┬────────────────────────────┘
                                              │
                     ┌────────────────────────┴────────────────────────┐
                     ▼                                                 ▼
        ┌─────────────────────────┐                       ┌─────────────────────────┐
        │  Morning Glory Spillway │                       │  Deep Bottom Outlets    │
        │  (Шахтный водосброс)    │                       │  (Донные водовыпуски)   │
        ├─────────────────────────┤                       ├─────────────────────────┤
        │ • Morning-glory funnel  │                       │ • Two pressure tunnels  │
        │   diameter: 32 m        │                       │ • Radial gate control   │
        │ • Tunnel diameter: 10 m │                       │ • Capacity: 800-1000    │
        │ • Capacity: 1,200 m³/s  │                       │   m³/s                  │
        └─────────────────────────┘                       └─────────────────────────┘
```
...
## 5. Charvak Hydroelectric Power Station
...
## 7. Seismic Design & Monitoring

* **Seismic Building Standard:** Designed and verified for **Magnitude 9 earthquakes** on the MSK-64 scale (сейсмостойкость 9 баллов).
* **Instrumented Surveillance Network:** Over 2,000 physical sensors integrated within the dam body:
  * Piezometers measuring pore pressure and seepage gradient.
  * Inclinometers and surface geodetic benchmark pillars measuring settlement and horizontal displacement.
  * High-sensitivity accelerometers and seismographs tracking microseismic ground motions.
  * Seepage flow rate measuring weirs in drainage galleries.
* **Supervising Regulatory Bodies:**
  * **Uzgosvodkhoznadzor** (State Inspectorate for Supervision of Geological Safety and Technical Condition of Water Facilities).
  * Ministry of Emergency Situations of the Republic of Uzbekistan (MCHS / FVV).
...
## 9. Parameters for Dam-Break Modeling

For hydrodynamic, flood-routing, and civil defense simulations (such as [charvak-simulation.github.io](https://charvak-simulation.github.io/)), the following benchmark values are used:
...
1. **CAWater-Info Portal:** Database of Hydraulic Structures in the Aral Sea Basin ([cawater-info.net](https://www.cawater-info.net/)).
2. **JSC "Uzbekhydroenergo":** Official corporate technical documentation of the Charvak HPP Cascade ([uzgidro.uz](https://uzgidro.uz/)).
3. **Ministry of Water Resources of the Republic of Uzbekistan:** Official water cadastre and reservoir registries.
4. **Sredazgidroproyekt Institute:** Original design archive and structural blueprints for the Charvak rockfill dam (Tashkent, USSR/Uzbekistan).
5. **Froehlich, D. C. (2008):** *"Embankment Dam Breach Parameters Revisited"*, Journal of Water Resources Planning and Management, 134(2), 170–180.
6. **MCHS Republic of Uzbekistan (June 2023):** Civil protection inter-agency emergency scenario reports and disaster simulation guidelines.
